...
// ============================================
// FAKE NEWS DETECTION - MAIN JS
// 3D Animations, Particles, Navigation
// ============================================
...
function initParticles() {
    ...
    class Particle {
        constructor() {
            ...
            this.color = Math.random() > 0.5 ? '#00f3ff' : '#ff0055';
...
function initScrollAnimations() {
    ...
    document.querySelectorAll('.glass-card, .feature-card, .model-card').forEach(el => {
        el.style.opacity = '0';
